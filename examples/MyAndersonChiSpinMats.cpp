...
// Start calculations
  try {
    ...
    // Init two particle Green's function object on Matsubara
    EDLib::gf::ChiLoc<HType, alps::gf::matsubara_positive_mesh, alps::gf::statistics::statistics_type> susc_mats(params, ham, alps::gf::statistics::statistics_type::BOSONIC);
    // Compute and save spin susceptibility
    susc_mats.compute();
    susc_mats.save(ar, "results");
